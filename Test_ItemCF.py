...
class ItemBasedCF():
    ...
    def generate_dataset(self, filename, pivot=0.7):
        ...
        #print("testset:",self.testset['5988']['159'])
    ...
    def calc_movie_sim(self):
        ...
        #print("movie_popular:",self.movie_popular)
        ...
        print("*************movie_sim_mat*********:",self.movie_sim_mat)
    ...
    def recommend(self, user):
        ...
        print("=========itemsim_mat==========:",self.movie_sim_mat)
    ...
    def evaluate(self):
        ...
        precision = hit / (1.0 * recom_count)
        recall = hit / (1.0 * test_count)
        coverage = len(all_rec_movies) / (1.0 * self.movie_count)
        popularity = popular_sum / (1.0 * recom_count)
