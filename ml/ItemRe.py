...
class ItemBasedCF():
        ...
        for user, movies in self.trainset.iteritems():
            for m1 in movies:
                for m2 in movies:
                    ...
                    itemsim_mat[m1][m2] += 1
                    print >> sys.stderr, 'itemsim_mat m1 = %s' % m1
                    print >> sys.stderr, 'itemsim_mat m2 = %s' % m2
                    print >> sys.stderr, 'itemsim_mat itemsim_mat = %s' % itemsim_mat
                    print >> sys.stderr, 'itemsim_mat itemsim_mat[m1] = %s' % itemsim_mat[m1]
                    print >> sys.stderr, 'itemsim_mat itemsim_mat[m2] = %s' % itemsim_mat[m2]
    ...
    def evaluate(self):
        ...
        for i, user in enumerate(self.trainset):
            ...
            recommend_movies = self.recommend(user)
            for movie, w in recommend_movies:
...
if __name__ == '__main__':
    ...
    ratingfile = 'D:/ml-1m/ratings.dat'
    itemcf = ItemBasedCF()
